...
describe 'navigate' do
  ...
  let(:post) do
    Post.create(date: Data.today, rationale: "Rationale", user_id: user.id, overtime_request: 3.5)
  end
  before do
  ...
  describe 'delete' do
    it 'can be deleted' do
      ...
      post_to_delete = Post.create(date: Date.today, rationale: "deleted post", user_id: delete_user.id, overtime_request: 3.5)
      visit posts_path
