...
describe 'navigate' do
  ...
  describe 'index' do
    ...
    it 'has a scope so that only post creators can see their posts' do
      post1 = Post.create(date: Date.today, rationale: "some other posts", user_id: @user.id)
      post2 = Post.create(date: Date.today, rationale: "some other posts", user_id: @user.id)
